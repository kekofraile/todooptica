...
const TodoOptica = (() => {
  const appointmentProfiles = {
    valladolid: {
      ...
      label: "Valladolid",
      defaultNote:
        "Horario Valladolid: Lun–Vie 10:00–20:30 (cada 30 min) · Sáb 10:15–14:00 (cada 15 min).",
      rules: {
        weekday: {
          start: "10:00",
          end: "20:30",
          intervalMinutes: 30,
          label: "Lun–Vie 10:00–20:30 (cada 30 min)",
        },
        saturday: {
          start: "10:15",
          end: "14:00",
    ...
    madrid: {
      ...
      label: "Madrid",
      defaultNote:
        "Madrid: horario flexible de lunes a viernes entre 10:00 y 20:00.",
      rules: {
        weekday: {
          start: "10:00",
          end: "20:00",
          intervalMinutes: 30,
          label: "Lun–Vie 10:00–20:00 (cada 30 min)",
        },
      },
      closedWeekdays: [0, 6],
      holidaysByYear: {},
